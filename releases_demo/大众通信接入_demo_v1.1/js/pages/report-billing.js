...
(function () {
  ...
  var allRows = dazhongFirst(window.MockBillingStatsRows || []);
  ...
  function render() {
    ...
    filteredRows = dazhongFirst(allRows);
    return [
      ...
      '<input id="billingDateFrom" value="2026-07-01" aria-label="计费开始日期">',
      '<span>&rarr;</span>',
      '<input id="billingDateTo" value="2026-07-23" aria-label="计费结束日期">',
  ...
  function query() {
    ...
    filteredRows = dazhongFirst(allRows.filter(function (item) {
