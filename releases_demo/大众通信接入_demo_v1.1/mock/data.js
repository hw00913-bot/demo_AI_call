...
var MockSceneList = [
  ...
  { id: 17, uuid: '9f6d9a40-2fb3-4c56-8b21-202607140017', name: '华东店-冷线索跟进-大众通信', status: 'running', remoteStatus: 2, task_type: 7, source: '接口传入', platform: '大众通信', line: 'DT-SH-001', maximumcall: 20, billingType: '按通话时长', assigned: 150, pending: 30, called: 120 },
  { id: 18, uuid: '04d5eb55-6bce-43a5-962a-202607140018', name: '南京售后回访-大众通信', status: 'paused', remoteStatus: 1, task_type: 7, source: '接口传入', platform: '大众通信', line: 'DT-NJ-001', maximumcall: 10, billingType: '按通话时长', assigned: 80, pending: 20, called: 60 },
  { id: 19, uuid: '7b6e87a1-5101-4380-8822-202607140019', name: '深圳新线索-大众通信', status: 'not_started', remoteStatus: 3, task_type: 7, source: '接口传入', platform: '大众通信', line: 'DT-SZ-001', maximumcall: 20, billingType: '按通话时长', assigned: 0, pending: 0, called: 0 }
];

/* 大众通信任务详情：对齐 GET /agent-api/new/user/{user_id}/task/{task_id}/edit 返回字段 */
var MockDazhongTaskEditDetail = {
  17: {
    ...
    new_task_extra: {
      ...
      destination_extension: '215870475195883520', destination_extension_list: [{ begin: '09:00', end: '21:00', destination_extension: '215870475195883520' }],
  ...
  18: {
    ...
    new_task_extra: {
      ...
      redial_conditions: { hangup_cause: null, da_status: [3, 4, 8, 12] },
      pop_mode: 2, plan_stop_code: 0, account_id: 'DZ-NJ-AFTERSALE'
    }
  },
  19: {
...
var MockCallStatsRows = [
  { date: '2026-07-14', sceneName: '华东店-冷线索跟进-大众通信', taskUuid: '9f6d9a40-2fb3-4c56-8b21-202607140017', platform: '大众通信', dialTotal: 200, rosterTotal: 200, connectedTotal: 160, missedTotal: 20, duration: '1小时38分15秒' },
  { date: '2026-07-13', sceneName: '南京售后回访-大众通信', taskUuid: '04d5eb55-6bce-43a5-962a-202607140018', platform: '大众通信', dialTotal: 150, rosterTotal: 150, connectedTotal: 110, missedTotal: 25, duration: '58分42秒' },
...
var MockBillingStatsRows = [
  { id: 1, dateFrom: '2026-07-01', dateTo: '2026-07-23', tenantName: '海南信州海星店', platform: '大众通信', billingType: '按通话时长', durationMinutes: 115 },
  { id: 2, dateFrom: '2026-07-01', dateTo: '2026-07-23', tenantName: '昆明东风南方三佳专营店', platform: '大众通信', billingType: '按通话时长', durationMinutes: 251 },
  { id: 3, dateFrom: '2026-07-01', dateTo: '2026-07-23', tenantName: '杭州东风南方杭城店', platform: '大众通信', billingType: '按通话时长', durationMinutes: 5120 },
  { id: 4, dateFrom: '2026-07-01', dateTo: '2026-07-23', tenantName: '东风日产-燃油车', platform: '大众通信', billingType: '按通话时长', durationMinutes: 146022 }
];
...
var MockClueDetailNEV = [
  ...
  { no: 6, time: '2026-07-14 14:00', code: 'CL20260714006', scene: '华东店-冷线索跟进-大众通信', type: '新线索', phone: '135****0006', storeCode: 'SH001', storeName: '上海静安店', callTime: '2026-07-14 14:15', startTime: '2026-07-14 09:00:00', endTime: '2026-07-14 09:00:35', status: '已接听', call_status: 1, duration: '00:02:00', intention_results: 1, level: '-', dispatch: '已下发', platform: '大众通信', callid: '2059190973162029091', sessionId: '2059190973162029091', recordingUrl: 'https://record.dazhong.example/callback/2059190973162029091.mp3', bailianTagName: 'A-高意向' },
  { no: 7, time: '2026-07-14 15:00', code: 'CL20260714007', scene: '华东店-冷线索跟进-大众通信', type: '新线索', phone: '135****0007', storeCode: 'CQ001', storeName: '重庆渝兴店', callTime: '2026-07-14 15:20', startTime: '2026-07-14 09:02:00', endTime: '2026-07-14 09:02:00', status: '已接听', call_status: 8, duration: '00:01:00', intention_results: 3, level: '-', dispatch: '未下发', platform: '大众通信', callid: '2059190973162029093', sessionId: '2059190973162029093', bailianTagName: 'E-需再次跟进' },
  { no: 8, time: '2026-07-14 16:00', code: 'CL20260714008', scene: '华东店-冷线索跟进-大众通信', type: '冷线索', phone: '135****0008', storeCode: 'CQ001', storeName: '重庆渝兴店', callTime: '2026-07-14 16:10', startTime: '2026-07-14 09:01:00', endTime: '2026-07-14 09:01:00', status: '空号', call_status: 3, duration: '00:00:00', intention_results: 6, level: '-', dispatch: '未下发', platform: '大众通信', callid: '2059190973162029092', sessionId: '2059190973162029092', bailianTagName: 'E-需再次跟进' },
  { no: 9, time: '2026-07-14 17:00', code: 'CL20260714009', scene: '深圳新线索-大众通信', type: '冷线索', phone: '135****0009', storeCode: 'SZ001', storeName: '深圳南山店', callTime: '2026-07-14 17:10', startTime: '2026-07-14 09:09:00', endTime: '2026-07-14 09:09:00', status: '未评级', call_status: 9, duration: '00:00:00', intention_results: null, level: '-', dispatch: '未下发', platform: '大众通信', callid: '2059190973162029100', sessionId: '2059190973162029100', bailianTagName: '-' }
];
...
var MockTagSuppliers = [
  ...
  { id: 'dazhong', localCode: 'SUP-DZ',    name: '大众通信', status: 'enabled' }
];
...
var MockSupplierTagPool = {
  ...
  'dazhong': [
    { id: 'dazhong_1', localCode: 'TAG-DZ-001', name: 'A-高意向',       sort: 1,  platformTagId: null },
    { id: 'dazhong_2', localCode: 'TAG-DZ-002', name: 'B-意向客户',     sort: 2,  platformTagId: null },
    { id: 'dazhong_3', localCode: 'TAG-DZ-003', name: 'C-潜在客户',     sort: 3,  platformTagId: null },
    { id: 'dazhong_4', localCode: 'TAG-DZ-004', name: 'D-一般意向',     sort: 4,  platformTagId: null },
    { id: 'dazhong_5', localCode: 'TAG-DZ-005', name: 'E-需再次跟进',   sort: 5,  platformTagId: null },
    { id: 'dazhong_6', localCode: 'TAG-DZ-006', name: 'F-号码无效',     sort: 6,  platformTagId: null }
  ]
};
