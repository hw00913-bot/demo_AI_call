...
(function () {
  ...
  var allRows = [
    { phone: '138****0001', leadId: 'LEAD_DS_001', platform: '电声平台', attemptCount: 1, lastVisitTime: '2026-07-02 10:15:00', visitCount: 1, callStatus: '已接听', record: '客户确认周日到店并关注首保礼包。', level: 'A(高意向)', tags: ['高意向', '周日到店', '已加微'], sceneName: '东风日产-新线索-内部调优', firstVisitTime: '2026-07-02 10:15:00', secondVisitTime: '-', thirdVisitTime: '-', detailTags: { intent: 'A(高意向)', concern: '首保礼包', city: '广州', arrivalTime: '周日', buyTime: '近期', callTag: '已加微' }, summary: '客户确认周日到店并关注首保礼包，建议门店及时承接。' },
    ...
    { phone: '185****0004', leadId: 'LEAD_DS_004', platform: '电声平台', attemptCount: 1, lastVisitTime: '2026-07-01 16:22:00', visitCount: 1, callStatus: '已接听', record: '客户表示车辆已售，无需继续跟进。', level: 'D(无意向)', tags: ['无意向', '车辆已售'], sceneName: '东风日产-冷线索-上线验证', firstVisitTime: '2026-07-01 16:22:00', secondVisitTime: '-', thirdVisitTime: '-', detailTags: { intent: 'D(无意向)', concern: '车辆已售', city: '上海', arrivalTime: '-', buyTime: '已购车', callTag: '无需回访' }, summary: '客户车辆已售，无需继续跟进。' },
