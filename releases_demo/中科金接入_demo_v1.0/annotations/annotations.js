  ...
  "scene-list": [
    ...
    },
    {
      ...
      sections: {
        ...
        fieldDesc: "1.导入客户数 = 去重后的传入/导入手机号总数；\n2.外呼客户数 = 成功提交到外部接口的去重手机号数；\n3.去重过滤客户数 = 从回调通话状态识别的过滤客户数（去重）；\n4.总接听率 = 接听客户数/外呼客户数；\n5.平均通话时长= 总通话时长/接听客户数；\n6.总外呼数 = 成功提交的不去重手机号数；\n7.过滤比例 = 去重过滤客户数/导入客户数；\n8.意向分布环形图按意向等级展示占比，意向分类取中科金【aiTagName】；\n9.意向分类区块：某类客户占比、某类客户数（取配置选中的意向标签对应的客户数）；\n10.通话时段占比：不同通话时长区间的占比。",
