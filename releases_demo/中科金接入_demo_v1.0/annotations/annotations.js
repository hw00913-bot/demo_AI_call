  ...
  "result-records": [
    {
      ...
      sections: {
        ...
        dataSource: "中科金 API 通话记录回调",
        valueLogic: "通过通话记录回调+对话文本推送 webhook 接口获取通话的信息。",
      ...
      desc: "1. 功能名称：通话记录列表<br>2. 功能说明：查看每一通外呼的结果，包括通话时间、时长、通话状态、外呼总结、最后通话节点等信息。<br>3. 权限范围：超级管理员、租户管理员、租户运营可见。超级管理员读取全部通话记录，租户仅读取本租户数据。<br>4. 数据来源：中科金 API 通话记录回调<br>5. 取值逻辑：通过通话记录回调+对话文本推送 webhook 接口获取通话的信息。<br>6. 字段说明：1.用户号码：对应接口文档 cellphone\n2.通话开始时间：对应接口文档callStartTime\n3.通话结束时间：对应接口文档callEndTime\n4.通话时长：对应接口文档callDurationSec\n5.场景名称：本地字段\n6.通话状态：对应接口文档callStatus\n7.外呼总结：百炼智能体返回的通话小结\n8.智能平台：取本地字段\n9.最后通话节点：仅科大显示<br>7. 交互说明：表格列表，支持按用户号码、场景名称、通话状态、智能平台筛选。点击「详情」打开通话详情弹窗，展示外呼小结、会话对话记录、标签合集、意向等级等。<br>8. 判断规则：待确认<br>9. 异常规则：待确认<br>10. 其他说明：待确认"
    },
    {
      id: "2",
      page: "result-records",
