...
(function () {
  ...
  function renderDetailInfo(item = {}) {
    const fields = [
      ...
      ['线索跟进状态', '跟进完成'],
      ['跟进失败原因', '-'],
      ['话单状态', item.status || '已接通'],
      ['通话开始时间', item.startTime || '2026-01-02 12:00'],
      ['通话结束时间', item.endTime || '2026-01-02 12:00'],
      ['主叫号码', '1380009999'],
      ['被叫号码', item.phone || '13444556677'],
      ['通话时长', item.duration || '27 秒'],
      ['意向等级', '高'],
      ['线索状态', '有效'],
      ['无效原因', '-'],
      ['是否重拨', item.isRedial ? '是' : '否'],
      ['意向车系', '天籁'],
      ['意向车型', '智驾尊贵版'],
      ['所在地', '广东-广州-天河'],
      ['客户购车门店', '广州某下店'],
